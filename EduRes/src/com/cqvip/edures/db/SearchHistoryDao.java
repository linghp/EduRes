...
public class SearchHistoryDao extends AbstractDao<SearchHistory, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Historyword = new Property(1, String.class, "historyword", false, "HISTORYWORD");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SEARCH_HISTORY' (" + //
                ...
                "'HISTORYWORD' TEXT UNIQUE ," + // 1: historyword
                "'DATE' INTEGER);"); // 2: date
    }
    ...
    public SearchHistory readEntity(Cursor cursor, int offset) {
        SearchHistory entity = new SearchHistory( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // historyword
    ...
    public void readEntity(Cursor cursor, SearchHistory entity, int offset) {
        ...
        entity.setHistoryword(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
