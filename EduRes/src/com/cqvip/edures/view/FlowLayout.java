...
/**
 * http://www.jcodecraeer.com/a/anzhuokaifa/androidkaifa/2013/0305/969.html
 * */
		...
		public LayoutParams(Context context, AttributeSet attrs) {
			...
			try {
				...
				breakLine = a.getBoolean(
						...
						false);
				Log.i("LayoutParams", horizontalSpacing + "----" + breakLine);
			} finally {
				a.recycle();
			}
		}
