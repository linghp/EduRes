...
public class DateSortedExpandableListAdapter extends BaseExpandableListAdapter{
     ...
     */
    /* package */ public boolean moveCursorToChildPosition(int groupPosition,
            int childPosition) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if(isExpanded){
        	Drawable img = mContext.getResources().getDrawable(R.drawable.ic_arrow_white_up);
        	// 调用setCompoundDrawables时，必须调用Drawable.setBounds()方法,否则图片不显示
        	img.setBounds(0, 0, img.getMinimumWidth(), img.getMinimumHeight());
        	item.setCompoundDrawables(img, null, null, null); //设置左图标
        }else{
        	Drawable img = mContext.getResources().getDrawable(R.drawable.ic_arrow_white_down);
        	// 调用setCompoundDrawables时，必须调用Drawable.setBounds()方法,否则图片不显示
        	img.setBounds(0, 0, img.getMinimumWidth(), img.getMinimumHeight());
        	item.setCompoundDrawables(img, null, null, null); //设置左图标
        }
